            ...
            <div class="inner">
               ...
               <div class="row" >
                        ...
                        <div class="container" id="container" style="margin:auto;"></div>
                        	<div class="col-4">
						   <img id="image" src="/projectupload/${vo.picture }" alt="" style="width: 350px; height: 300px; margin-left: 350px;">
						  
						   <pre style="height: 350px; width: 800px; margin-left: 225px;"><c:out value="${vo.content }"/></pre>
						   </div>
